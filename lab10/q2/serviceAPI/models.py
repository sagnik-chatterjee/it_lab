...
class Driver(models.Model):
    ...
    STATUS_OPTIONS = (("AV", "AVAILABLE"), ("OFF", "OFFLINE"), ("BK", "BOOKED"))
...
class Trip(models.Model):
    commuter = models.ForeignKey(
        Commuter, null=True, related_name="commuter", on_delete=models.CASCADE
    )
    driver = models.ForeignKey(
        Driver, null=True, related_name="driver", on_delete=models.CASCADE
    )
